  ...
  <div>
    <section class="controlbar">
      ...
      <div class="controlpanel" id="draft_name">
        <button class="accordion active">Draft Name</button>
        <div class="panel">
      ...
      <div class="controlpanel" id="controls">
        ...
        <div class="panel">
          ...
          <span class="panelitem" id="showcontrols">
            <label class="panelitemlabel" for="addright">
              Add tablets on:</label
            >
      ...
      <div class="controlpanel" id="display">
        ...
        <div class="panel">
          ...
          <span class="panelitem" id="showcontrols">
            <label class="panelitemlabel" for="invertsz">S ↔Z</label>
            <span class="panelitemvalue">
              <label class="switch">
      ...
      <div class="controlpanel" id="repeats">
        ...
        <div id="palete">
          ...
          <div class="panel" id="fg">
            <label>Foreground Colour:</label>
            <Colorbox></Colorbox>
            <span class="panelitem">
              <label class="panelitemlabel"> Colour Name:</label>
              <label class="panelitemvalue" id="colourname"> </label>
            </span>
            <div id="coloursliders">
              <span class="panelitem">
                <label class="panelitemlabel">Red:</label>
                <span class="panelitemvalue">
                  <input
                    type="range"
                    min="0"
              ...
              <span class="panelitem">
                <label class="panelitemlabel">Green:</label>
                <span class="panelitemvalue">
                  <input
                    type="range"
                    min="0"
              ...
              <span class="panelitem">
                <label class="panelitemlabel">Blue:</label>
                <span class="panelitemvalue">
                  <input
                    type="range"
                    min="0"
